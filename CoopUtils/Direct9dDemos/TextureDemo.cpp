...
static bool Init()
{
	...
	hr = g_pD3dDevice->CreateTexture(nColumns, nRows, 1, 0, D3DFMT_X8R8G8B8, D3DPOOL_SYSTEMMEM, &pSystemTexture, NULL);
	...
	hr = g_pD3dDevice->CreateTexture(nColumns, nRows, 1, 0, D3DFMT_X8R8G8B8, D3DPOOL_DEFAULT, &g_pVideoTexture, NULL);
